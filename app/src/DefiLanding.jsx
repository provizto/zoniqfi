...
const currentDomain = typeof window !== 'undefined' ? window.location.hostname.replace('defi.', '').replace('www.', '') : 'zoniqfi.com';
  ...
  return (
    <div id="vzt-landing-page">
      <style>{`
        ...
        #vzt-landing-page .hero { padding: 160px 8% 40px 8% !important; text-align: center !important; background: radial-gradient(circle at top, rgba(20, 184, 166, 0.15) 0%, transparent 60%) !important; }
        ...
        .vzt-promo-badge { display: inline-flex; align-items: center; gap: 8px; background: rgba(20, 184, 166, 0.1); border: 1px solid rgba(20, 184, 166, 0.3); color: #14b8a6; padding: 6px 16px; border-radius: 9999px; font-size: 0.85rem; font-weight: 600; margin-bottom: 20px; }
        .vzt-promo-pulse { height: 8px; width: 8px; border-radius: 50%; background-color: #14b8a6; animation: vztPulse 2s infinite; }
        @keyframes vztPulse { 0% { transform: scale(0.95); box-shadow: 0 0 0 0 rgba(20, 184, 166, 0.7); } 70% { transform: scale(1); box-shadow: 0 0 0 8px rgba(20, 184, 166, 0); } 100% { transform: scale(0.95); box-shadow: 0 0 0 0 rgba(20, 184, 166, 0); } }
        ...
        #vzt-landing-page .pricing-card:hover { border-color: #14b8a6 !important; transform: translateY(-4px) !important; }
        ...
        .vzt-tg-btn { display: inline-flex; align-items: center; gap: 12px; background: linear-gradient(90deg, #14b8a6 0%, #3b82f6 100%); color: #fff !important; font-weight: 700; font-size: 1.1rem; padding: 16px 36px; border-radius: 14px; text-decoration: none !important; box-shadow: 0 8px 20px rgba(20, 184, 166, 0.3); transition: all 0.3s ease; }
      ...
      <header>
        <div className="brand-wrapper">
          ...
          <div className="logo">ZONIQFI // DEFI</div>
        </div>
        <nav>
          <a href={`https://${currentDomain}`}>← Back to Home</a>
          <a href="#pricing">Packages</a>
          <a href="#faq">FAQ</a>
        </nav>
        <a href="https://t.me/zoniqfi" target="_blank" rel="noopener noreferrer" className="btn-launch" style={{ background: '#14b8a6' }}>
          Get Integration
        </a>
      </header>
      ...
      <section className="hero">
        ...
        <h1>PREMIUM SOLANA dAPP INFRASTRUCTURE</h1>
      ...
      <section id="pricing" className="pricing-section">
        ...
        <div className="vzt-cta-wrapper">
          <div className="vzt-cta-card">
            ...
            <a href="https://t.me/zoniqfi" target="_blank" rel="noopener noreferrer" className="vzt-tg-btn">
