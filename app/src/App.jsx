    ...
    <>
      ...
      <footer className="dapp-footer" style={{ 
        ...
        <div className="footer-links-row" style={{ 
          ...
          <a href="https://github.com/provizto/vzt#readme" target="_blank" rel="noopener noreferrer" style={{ color: '#94a3b8', textDecoration: 'none', transition: 'color 0.2s' }}>Documentation</a>
