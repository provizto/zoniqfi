...
const Landing = ({ totalValueLocked, swapsCount, onLaunchApp }) => {
  ...
  // Jalankan inject FontAwesome & Google Fonts
  useEffect(() => {
  ...
  // DAFTAR PAKET DAN LINK DEMO SUB-DOMAIN
  const pricingPackages = [
    {
      ...
      price: "$499",
      demoLink: "https://entry.zoniqfinance.com"
    },
    {
      ...
      price: "$1,299",
      popular: true,
      demoLink: "https://velocity.zoniqfinance.com"
    },
    {
      ...
      price: "$1,199",
      demoLink: "https://whale.zoniqfinance.com"
    },
    {
      ...
      price: "$1,099",
      demoLink: "https://staking.zoniqfinance.com"
    },
    {
  ...
  const faqData = [
    { q: "What is ZoniqFi?", a: "ZoniqFi is a premium Web3 infrastructure provider offering turnkey, plug-and-play white-label DeFi dApps on the Solana blockchain." },
    { q: "How does the White-Label licensing model work?", a: "Once you purchase a package, our team handles all frontend customization and deploys the fully functional dApp directly to your project's custom domain." },
    { q: "Is this infrastructure protected against automated exploits?", a: "Absolutely. The Swap module is equipped with MEV Secure protocols via Jito Engine to shield retail traders." }
  ];
    ...
    <div id="vzt-landing-page">
      <style>{`
        #vzt-landing-page {
          ...
          overflow-x: hidden !important; text-align: left !important;
        }
        #vzt-landing-page header {
          display: flex !important; justify-content: space-between !important; align-items: center !important;
          padding: 20px 8% !important; border-bottom: 1px solid #1f2937 !important;
          background: rgba(11, 15, 25, 0.8) !important; backdrop-filter: blur(12px) !important;
          position: fixed !important; width: 100% !important; top: 0 !important; left: 0 !important; z-index: 99999 !important;
        }
        #vzt-landing-page .logo { font-size: 1.4rem !important; font-weight: 700 !important; background: linear-gradient(45deg, #fff, #3b82f6) !important; -webkit-background-clip: text !important; -webkit-text-fill-color: transparent !important; }
        #vzt-landing-page nav a { color: #f3f4f6 !important; text-decoration: none !important; margin: 0 15px !important; font-size: 0.95rem !important; }
        #vzt-landing-page .btn-launch { background: linear-gradient(135deg, #8b5cf6, #3b82f6) !important; color: #fff !important; padding: 10px 22px !important; border-radius: 8px !important; font-weight: 600 !important; border: none !important; cursor: pointer !important; }
        #vzt-landing-page .hero { padding: 180px 8% 60px 8% !important; text-align: center !important; background: radial-gradient(circle at top, rgba(59, 130, 246, 0.15) 0%, transparent 60%) !important; }
        #vzt-landing-page .hero h1 { font-size: 3.2rem !important; font-weight: 800 !important; margin-bottom: 20px !important; background: linear-gradient(90deg, #fff 40%, #14b8a6) !important; -webkit-background-clip: text !important; -webkit-text-fill-color: transparent !important; }
        #vzt-landing-page .hero p { font-size: 1.2rem !important; color: #94a3b8 !important; max-width: 800px !important; margin: 0 auto !important; }
        ...
        #vzt-landing-page .pricing-card { background: #111827 !important; border: 1px solid #1f2937 !important; border-radius: 16px !important; padding: 35px 25px !important; display: flex !important; flex-direction: column !important; justify-content: space-between !important; position: relative !important; }
        #vzt-landing-page .pricing-card.popular-card { border: 2px solid #8b5cf6 !important; }
        ...
        #vzt-landing-page .btn-demo-link { background: transparent !important; color: #94a3b8 !important; text-align: center !important; padding: 10px !important; border-radius: 8px !important; font-weight: 600 !important; text-decoration: none !important; border: 1px solid #1f2937 !important; display: block !important; margin-bottom: 10px !important; font-size: 0.9rem !important; }
        #vzt-landing-page .btn-demo-link:hover { border-color: #14b8a6 !important; color: #14b8a6 !important; }
        #vzt-landing-page .btn-order { background: #1f2937 !important; color: #fff !important; text-align: center !important; padding: 12px !important; border-radius: 8px !important; font-weight: 600 !important; text-decoration: none !important; border: 1px solid #374151 !important; display: block !important; }
        ...
        #vzt-landing-page .faq-answer { padding: 0 20px !important; max-height: 0px; overflow: hidden !important; transition: max-height 0.3s ease !important; color: #94a3b8 !important; }
        #vzt-landing-page footer { border-top: 1px solid #1f2937 !important; padding: 40px 8% !important; background: #060911 !important; text-align: center !important; }
        @media (max-width: 1024px) { #vzt-landing-page .pricing-grid { grid-template-columns: repeat(2, 1fr) !important; } }
        @media (max-width: 768px) { #vzt-landing-page .pricing-grid { grid-template-columns: 1fr !important; } }
      `}</style>
      ...
      <header>
        ...
        <button onClick={onLaunchApp} className="btn-launch">Live dApp Demo</button>
      </header>

      <section className="hero">
        <h1>Premium Solana White-Label dApp Infrastructure</h1>
        <p>Deploy your token utility ecosystem within 24 hours. Plug-and-play DeFi modules designed securely on-chain.</p>
      </section>
      ...
      <footer>
        <p>© 2026 ZoniqFi. All Rights Reserved.</p>
      </footer>
    </div>
  );
};
